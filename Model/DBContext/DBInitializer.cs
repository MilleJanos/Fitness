...
namespace Fitness.Model.DBContext
{
    public class DBInitializer : CreateDatabaseIfNotExists<FitnessDB>    // DropCreateDatabaseAlways OR CreateDatabaseIfNotExists
    {
        ...
        private void AddLanses(FitnessDB context)
        {
            ...
            lanses.Add(new Lanse { Id = 0, TypeId = 0, Type = lanse_types.ElementAt(0), RemainingTimes = 7, UserId = 0, User = users.ElementAt(0), Price = 10, StartDate = new DateTime(2019, 01, 03), EndDate = new DateTime(2019, 05, 03), Active = true });
            lanses.Add(new Lanse { Id = 1, TypeId = 2, Type = lanse_types.ElementAt(2), RemainingTimes = 5, UserId = 0, User = users.ElementAt(0), Price = 25, StartDate = new DateTime(2019, 02, 04), EndDate = new DateTime(2019, 06, 04), Active = true });
            lanses.Add(new Lanse { Id = 2, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 0, User = users.ElementAt(0), Price = 5, StartDate = new DateTime(2019, 03, 05), EndDate = new DateTime(2019, 08, 05), Active = true });
            ...
            lanses.Add(new Lanse { Id = 4, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 1, User = users.ElementAt(1), Price = 3, StartDate = new DateTime(2019, 05, 07), EndDate = new DateTime(2019, 10, 07), Active = false });
            ...
            lanses.Add(new Lanse { Id = 6, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 3, User = users.ElementAt(3), Price = 30, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = true });
            ...
            lanses.Add(new Lanse { Id = 8, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 1, User = users.ElementAt(1), Price = 10, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = false });
            lanses.Add(new Lanse { Id = 9, TypeId = 1, Type = lanse_types.ElementAt(1), RemainingTimes = 30, UserId = 1, User = users.ElementAt(1), Price = 9, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = true });
            lanses.Add(new Lanse { Id = 10, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 1, User = users.ElementAt(1), Price = 20, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = true });
            ...
            lanses.Add(new Lanse { Id = 12, TypeId = 0, Type = lanse_types.ElementAt(0), RemainingTimes = 7, UserId = 1, User = users.ElementAt(1), Price = 32, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = true });
            lanses.Add(new Lanse { Id = 13, TypeId = 3, Type = lanse_types.ElementAt(3), RemainingTimes = 10, UserId = 1, User = users.ElementAt(1), Price = 74, StartDate = new DateTime(2019, 07, 09), EndDate = new DateTime(2019, 12, 09), Active = false });
