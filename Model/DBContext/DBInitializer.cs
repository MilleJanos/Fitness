...
namespace Fitness.Model.DBContext
{
    public class DBInitializer : DropCreateDatabaseAlways<FitnessDB>    // DropCreateDatabaseAlways OR CreateDatabaseIfNotExists
    {
        ...
        {
            context.User.Add(new User { Id = 0, Barcode = "1508930965252523109412047", FirstName = "Andrea-Edina", LastName = "Fabian", BirthDate = new DateTime(1997, 1, 1),Email = "fabiansemail@gmail.com", Password = "fabian".GetHashCode().ToString(), PhoneNumber = "0000000000", Image = "profile_0.png", Address = "Address0", OtherInformations = "Other\ninformations",   RegistrationDate = new DateTime(2019, 5, 15),  Active = true, Role = "admin"        });
            context.User.Add(new User { Id = 1, Barcode = "1508930965252523109412047", FirstName = "Janos", LastName = "Mille", BirthDate = new DateTime(1997, 4, 24),Email = "millejanos31@gmail.com", Password = "mille".GetHashCode().ToString(), PhoneNumber = "0744793412", Image = "profile_1.png",         Address = "Address1", OtherInformations = "Other\ninformations",   RegistrationDate = new DateTime(2019, 5, 16),  Active = true, Role = "admin"        });
            context.User.Add(new User { Id = 2, Barcode = "0986508930965252523109415", FirstName = "I am", LastName = "Guest",   BirthDate = new DateTime(2019, 3, 2), Email = "user@mail.com",          Password = "user".GetHashCode().ToString(), PhoneNumber = "0123456789", Image = "null",         Address = "Address2", OtherInformations = "Other\ninformations",   RegistrationDate = new DateTime(2019, 5, 17),  Active = true, Role = "receptionist" });

            context.User.Add(new User { Id = 3, Barcode = "8630969412020309525203024", FirstName = "Peter", LastName = "Kali",  BirthDate = new DateTime(2011, 1, 23), Email = "nomail3@mail.com",   Password = "no_password3".GetHashCode().ToString(), PhoneNumber = "0123456003", Image = "null", Address = "Address3", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 1, 11), Role = "client", Active = true });
            context.User.Add(new User { Id = 4, Barcode = "5231097109563471099467021", FirstName = "Alex", LastName = "Nemes",  BirthDate = new DateTime(2012, 4, 04), Email = "nomail4@mail.com",   Password = "no_password4".GetHashCode().ToString(), PhoneNumber = "0123456004", Image = "null", Address = "Address4", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 2, 12), Role = "client", Active = true });
            context.User.Add(new User { Id = 5, Barcode = "6508652525231094130952523", FirstName = "Ingrid", LastName = "Orosz",BirthDate = new DateTime(2013, 3, 15), Email = "nomail5@mail.com",   Password = "no_password5".GetHashCode().ToString(), PhoneNumber = "0123456005", Image = "null", Address = "Address5", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 3, 13), Role = "client", Active = true });
            context.User.Add(new User { Id = 6, Barcode = "3290523865734556409232349", FirstName = "Fred", LastName = "Mark",   BirthDate = new DateTime(2014, 3, 05), Email = "nomail6@mail.com",   Password = "no_password6".GetHashCode().ToString(), PhoneNumber = "0123456006", Image = "null", Address = "Address6", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 4, 14), Role = "client", Active = true });
            context.User.Add(new User { Id = 7, Barcode = "5291462049126401294612108", FirstName = "Breda", LastName = "Yap",   BirthDate = new DateTime(2015, 3, 15), Email = "nomail7@mail.com",   Password = "no_password7".GetHashCode().ToString(), PhoneNumber = "0123456007", Image = "null", Address = "Address7", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 5, 15), Role = "client", Active = true });
            context.User.Add(new User { Id = 8, Barcode = "5291462049126401294612000", FirstName = "Inactive", LastName = "One",BirthDate = new DateTime(2016, 2, 11), Email = "nomail8@mail.com",   Password = "no_password8".GetHashCode().ToString(), PhoneNumber = "0123452000", Image = "null", Address = "Address8", OtherInformations = "Other\ninformations", RegistrationDate = new DateTime(2011, 6, 16), Role = "client", Active = false });
        }
